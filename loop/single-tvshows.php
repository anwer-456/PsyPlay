...
<a href="http://pragmaticwebtools.com/client_works/movietest/donation/"><img src="http://movix.live/wp-content/uploads/2018/05/PayPal-Donate-Button-High-Quality-PNG.png" /></a>
</div>
...
<h3 class="hebrew-movie-name-single" itemprop="name"><?php the_field('the_films_name_is_in_hebrew'); ?></h3>
...
<?php if( get_field('torrent_time') ): ?>

<p class="torrent-time-cus-code"><strong>Torrent Time: </strong><?php the_field('torrent_time'); ?></p>
